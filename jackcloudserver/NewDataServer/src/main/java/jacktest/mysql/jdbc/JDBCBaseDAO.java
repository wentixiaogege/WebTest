...
public class JDBCBaseDAO<T> {
    ...
    JDBCDBConn conn = new JDBCDBConn();
    ...
    public void save(T entity) throws Exception{
        ...
        while(iter.hasNext()) {
            ...
            } else if (method.getReturnType().getSimpleName().indexOf("Set")!= -1) {
//            	 statement.setInt(++i, this.getInt(method, entity));// only guess
            	System.out.println("set parameter here******");
			} else {
