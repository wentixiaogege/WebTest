...
public class SmartMeterData implements java.io.Serializable {
	...
	public SmartMeterData(Integer smIndex, String smIeeeAddress, Integer rmsV1, BigDecimal rmsI1, Integer theta1, Integer rmsV2, BigDecimal rmsI2,
			Integer theta2, Integer rmsV3, BigDecimal rmsI3, Integer theta3, Integer magV1, Integer magI1, Integer magV2, Integer magI2,
			Integer magV3, Integer magI3, Integer smV, BigDecimal smI, BigDecimal power, BigDecimal energy, BigDecimal accumulatedEnergy,
			Integer status, Date timestamp) {
