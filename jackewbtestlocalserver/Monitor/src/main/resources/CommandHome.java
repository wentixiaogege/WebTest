...
/**
 * Home object for domain model class Command.
 * @see .Command
 * @author Hibernate Tools
 */
public class CommandHome {

	private static final Log log = LogFactory.getLog(CommandHome.class);
	...
	public void persist(Command transientInstance) {
		log.debug("persisting Command instance");
		try {
	...
	public Command merge(Command detachedInstance) {
		...
		try {
			Command result = (Command) sessionFactory.getCurrentSession()
	...
	public Command findById(int id) {
		...
		try {
			Command instance = (Command) sessionFactory.getCurrentSession()
					.get("Command", id);
			if (instance == null) {
	...
	public List findByExample(Command instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Command").add(Example.create(instance))
					.list();
