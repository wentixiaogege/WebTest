...
public class WyleModel implements Model{
	private static String[] current1 = { "RMS_I1_0", "RMS_I1_1", "RMS_I1_2",
		"RMS_I1_3", "RMS_I1_4", "RMS_I1_5", "RMS_I1_6" };
	private static String[] current2 = { "RMS_I2_0", "RMS_I2_1", "RMS_I2_2",
		"RMS_I2_3", "RMS_I2_4", "RMS_I2_5", "RMS_I2_6" };
	private static String[] current3 = { "RMS_I3_0", "RMS_I3_1", "RMS_I3_2",
		"RMS_I3_3", "RMS_I3_4", "RMS_I3_5", "RMS_I3_6" };
	private static String[] theta1 = { "THETA1_0", "THETA1_1", "THETA1_2",
		"THETA1_3", "THETA1_4", "THETA1_5", "THETA1_6" };
	private static String[] theta2 = { "THETA2_0", "THETA2_1", "THETA2_2",
		"THETA2_3", "THETA2_4", "THETA2_5", "THETA2_6" };
	private static String[] theta3 = { "THETA3_0", "THETA3_1", "THETA3_2",
		"THETA3_3", "THETA3_4", "THETA3_5", "THETA3_6" };
	...
	public  ArrayList<BaseElement> getBaseElement(
		...
		for (int i = 0; i < configList.size(); i++) {
			...
			if (action == 1) {
				...
				baseElement.config = "RMS_V2";
				baseElement.value = originInList.get(i + 7);
				baseElementList.add((BaseElement) baseElement.clone());
			} else if (action == 3) {
				baseElement.config = "RMS_V3";
				baseElement.value = originInList.get(i + 7);
				baseElementList.add((BaseElement) baseElement.clone());
			} else if (action == 9) {
...
//		int[] sequence = { 100, 100, 100, 100 }; // the v1, v2, v3, bv are  available
		...
		for (int i = 0; i < baseElementList.size(); i++) {
			// ********if RMS_V1 exists**************//
			if ("RMS_V1" == baseElementList.get(i).config) {
//				sequence[0] = i;
				v1 = i;
			}
			// ********if RMS_V2 exists**************//
			else if ("RMS_V2" == baseElementList.get(i).config) {
//				sequence[1] = i;
				v2 = i;
			}
			// ********if RMS_V3 exists**************//
			else if ("RMS_V3" == baseElementList.get(i).config) {
//				sequence[2] = i;
				v3 = i;
			}
			// ********if RMS_BV exists**************//
...
//				java.sql.Date dateDB = timeStamp.getTime();
				...
				if (actionV == "RMS_I1_0") {
					DataAccess.session = DataAccess.factory.openSession();
				    queryString = "from SmartMeterLoadConfig data where data.paramName1='RMS_V1' and data.paramName2='RMS_I1_0' and data.smId like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
				...
				else if (actionV == "RMS_I1_1") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.paramName1='RMS_V1' and data.paramName2='RMS_I1_1' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I1_2") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V1' and data.currentName='RMS_I1_2' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I1_3") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V1' and data.currentName='RMS_I1_3' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I1_4") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V1' and data.currentName='RMS_I1_4' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
				...
				else if (actionV == "RMS_I1_5") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V1' and data.currentName='RMS_I1_5' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I1_6") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V1' and data.currentName='RMS_I1_6' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
...
//				timeDate = getDate(originInByte);
				...
				if (actionV == "RMS_I2_0") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.paramName1='RMS_V2' and data.paramName2='RMS_I2_0' and data.smId like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I2_1") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V2' and data.currentName='RMS_I2_1' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I2_2") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V2' and data.currentName='RMS_I2_2' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I2_3") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V2' and data.currentName='RMS_I2_3' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I2_4") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V2' and data.currentName='RMS_I2_4' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I2_5") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V2' and data.currentName='RMS_I2_5' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I2_6") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V2' and data.currentName='RMS_I2_6' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
...
//				timeDate = getDate(originInByte);
				if (actionV == "RMS_I3_0") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.paramName1='RMS_V3' and data.paramName2='RMS_I3_0' and data.smId like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I3_1") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V3' and data.currentName='RMS_I3_1' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I3_2") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V3' and data.currentName='RMS_I3_2' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I3_3") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V3' and data.currentName='RMS_I3_3' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I3_4") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V3' and data.currentName='RMS_I3_4' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I3_5") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V3' and data.currentName='RMS_I3_5' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
				...
				else if (actionV == "RMS_I3_6") {
					DataAccess.session = DataAccess.factory.openSession();
					queryString = "from SmartMeterLoadConfig data where data.voltageName='RMS_V3' and data.currentName='RMS_I3_6' and data.sm_id like:smId";
					loadConfigQuery = DataAccess.session.createQuery(queryString).setInteger("smId", smId);
					loadConfigList = SmartMeterLoadConfigHome.searchOperation(loadConfigQuery);
					SmLoadConfigId = loadConfigList.get(0).getSmLoadConfigId(); // get(0) is this right???????
					thetaValue = baseElementList.get(index + 1).value;
