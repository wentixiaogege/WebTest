...
class DataAreaPlotPanel extends JFrame {
	String sql;
	String name;
	String ieeeAddress;
	
	public DataAreaPlotPanel (String name, String sql, String ieeeAddress){
		super();
		this.sql = sql;
		this.name = name;
	...
	ChartPanel creatAreaChartPanel() {
	       // JFrame f = new JFrame("JDBCTest");
	        ...
	        try{
	            ...
	            JFreeChart chart = ChartFactory.createAreaChart("Smart Meter" + name, "Time", name,
	                dataset,PlotOrientation.VERTICAL,true,true,false);
	            BarRenderer bar= null;
	            bar = new BarRenderer();
	            CategoryPlot plot =null;
	            //ChartFrame frame = new ChartFrame("Smart Meter " + ieeeAddress + " Data Plot", chart);
